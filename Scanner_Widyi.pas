...
type
        ...
        tokens  = (
        t_int, t_add, t_sub, t_mul, t_rdiv, t_double_mul, t_assign { ':=' },
        t_lbrack { '[' }, t_rbrack { ']' },
        t_lparent { '(' }, t_rparent { )' },
...
var
        ...
        procedure initiliaze; {membuka file}
        procedure scan;
...
begin
        case id of
        1       : writeln('Error -> unknow character ''', Ch, ''' Line :', LineNumber);
        2       : writeln('Error -> comment not limited Line', LinNumber);
        ...
        ':' :
                begin
                        ...
                        if (Ch = '=')
                                ...
                                WriteLn('Error -> unknow character '':'' Line :', LineNumber);
                                lookahead := true;
                                end;
                        Exit;
                end;
